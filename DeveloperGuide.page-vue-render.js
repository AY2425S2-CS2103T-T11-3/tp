...
with(this){return _c('p',[_v("The "),_c('em',[_v("Sequence Diagram")]),_v(" below shows how the components interact with each other for the scenario where the user issues the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete_stu 1")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('strong',[_v("API")]),_v(" of this component is specified in "),_c('a',{attrs:{"href":"https://github.com/AY2425S2-CS2103T-T11-3/tp/blob/master/src/main/java/seedu/address/ui/Ui.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Ui.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S2-CS2103T-T11-3/tp/blob/master/src/main/java/seedu/address/logic/Logic.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The sequence diagram below illustrates the interactions within the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" component, taking "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("execute(\"delete_stu 1\")")]),_v(" API call as an example.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S2-CS2103T-T11-3/tp/blob/master/src/main/java/seedu/address/storage/Storage.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage.java")])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("is a Resident Assistant (RA) or a Resident Fellow (RF) in a residence in NUS")]),_v(" "),_c('li',[_v("has a need to manage a significant number of contacts of the residents(students), staff, and external vendors in a university hall")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": ResiConnect helps a RA/RF manage contacts of the students of a hall or contacts of the students, staff and external vendors of hall events.\nHaving an address book to note down all the important information about the people they are in charge of. It would be helpful for coordinating hall events, emergency situation, etc.")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("RA")]),_v(" "),_c('td',[_v("add a new resident contact to my address book")]),_v(" "),_c('td',[_v("keep track of residents under my supervision")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("RA/RF")]),_v(" "),_c('td',[_v("add new staff's/ external vendor's contact")]),_v(" "),_c('td',[_v("keep track of staff or external vendor contact for event plannning or regular hall operations")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("RA")]),_v(" "),_c('td',[_v("delete a person contact")]),_v(" "),_c('td',[_v("remove people who no longer belong to my hall or no longer needed")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("RA")]),_v(" "),_c('td',[_v("view contacts")]),_v(" "),_c('td',[_v("check the details of my contacts")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("RA")]),_v(" "),_c('td',[_v("update a person's particulars")]),_v(" "),_c('td',[_v("keep their information accurate when changes occur")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("RA")]),_v(" "),_c('td',[_v("search for a resident by name, room number, or contact details")]),_v(" "),_c('td',[_v("quickly find the person that I need")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("RA")]),_v(" "),_c('td',[_v("sort persons alphabetically or by hall block")]),_v(" "),_c('td',[_v("organize my list efficiently")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("RF")]),_v(" "),_c('td',[_v("create an event")]),_v(" "),_c('td',[_v("keep track of event details")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("RF")]),_v(" "),_c('td',[_v("delete an event")]),_v(" "),_c('td',[_v("remove event that no longer needed")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("RF")]),_v(" "),_c('td',[_v("view all the events")]),_v(" "),_c('td',[_v("check the details of all the events")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("RF")]),_v(" "),_c('td',[_v("update details of an event")]),_v(" "),_c('td',[_v("ensure all information remains accurate and up to date")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("RF")]),_v(" "),_c('td',[_v("add people into an event")]),_v(" "),_c('td',[_v("keep track of who is involved in the event")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("RF")]),_v(" "),_c('td',[_v("remove people in an event")]),_v(" "),_c('td',[_v("remove people who are not involved in the event")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("RF")]),_v(" "),_c('td',[_v("view all the people in an event")]),_v(" "),_c('td',[_v("check the people that is involved in the event")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("RF")]),_v(" "),_c('td',[_v("search for an event by name or time range")]),_v(" "),_c('td',[_v("quickly find the event that I want")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ResiConnect")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("UC01: Add a student/staff/external vendor")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a student/staff/external vendor, along with his details.")])]),_v(" "),_c('li',[_c('p',[_v("ResiConnect saves the student/staff/external vendor and his details.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to list student/staff/external vendor.")])]),_v(" "),_c('li',[_c('p',[_v("ResiConnect shows a list of student/staff/external vendor that includes the latest student added.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The compulsory fields given by the user was invalid.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. ResiConnect shows an error message.")]),_v(" "),_c('li',[_v("1a2. User enters updated details.\nStep 1a1-1a2 is repeated until the data entered is valid. Use case resumes from Step 2.")])])]),_v(" "),_c('li',[_c('p',[_v("2a. The student/staff/external vendor already exists.\nUse case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("UC02: Delete a student/staff/external vendor")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list student/staff/external vendor.")])]),_v(" "),_c('li',[_c('p',[_v("ResiConnect shows a list of student/staff/external vendor.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific person in the student/staff/external vendor.")])]),_v(" "),_c('li',[_c('p',[_v("ResiConnect deletes the person.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. ResiConnect shows an error message.\nStep 3a1 is repeated until the data is valid. Use case repeat resumes from Step 2.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("UC03: Find a student/staff/external vendor")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to find if a student/staff/external vendor exists.")]),_v(" "),_c('li',[_v("ResiConnect shows a list of students/staff/external vendors that match the search criteria.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The fields entered by the user was invalid")]),_v(" "),_c('ul',[_c('li',[_v("1a1. ResiConnect shows an error message.")])])]),_v(" "),_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("UC04: Add an event")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to create a new event.")])]),_v(" "),_c('li',[_c('p',[_v("ResiConnect saves the event details.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to add participants (student/staff/external party) to the event.")])]),_v(" "),_c('li',[_c('p',[_v("ResiConnect saves the event details.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The compulsory fields given by the user was invalid.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. ResiConnect shows an error message.")]),_v(" "),_c('li',[_v("1a2. User enters updated details.\nStep 1a1-1a2 is repeated until the data entered is valid. Use case resumes from Step 2.")])])]),_v(" "),_c('li',[_c('p',[_v("3a. The data format (student index/staff index/external party index) is incorrect.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. ResiConnect shows an error message.")])]),_v(" "),_c('li',[_c('p',[_v("3a2. User enters updated details.")]),_v(" "),_c('p',[_v("Step 3a1-3a2 is repeated until the date entered is valid.")]),_v(" "),_c('p',[_v("Use case resumes from step 3.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("UC05: Delete an event")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list all events.")])]),_v(" "),_c('li',[_c('p',[_v("ResiConnect shows a list of events.")])]),_v(" "),_c('li',[_c('p',[_v("RF request to delete an event.")])]),_v(" "),_c('li',[_c('p',[_v("ResiConnect deletes the event and updates the list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list of events is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The selected event name is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. ResiConnect shows an error message.")])]),_v(" "),_c('li',[_c('p',[_v("3a2. User enters updated valid event name.")]),_v(" "),_c('p',[_v("Step 3a1-3a2 is repeated until the date entered is valid.")]),_v(" "),_c('p',[_v("Use case resumes from step 4.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Data Size: The system should handle up to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("10,000")]),_v(" contacts and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("500")]),_v(" events simultaneously without performance degradation.")]),_v(" "),_c('li',[_v("Data Volatility: The system should allow for quick updates since contact information can change frequently.")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"environment-requirements"}},[_v("Environment Requirements"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#environment-requirements","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Technical Environment: The system should be compatible with any mainstream OS with "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Java 17 JDK+FX Azul distribution")]),_v(" installed.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Response Time: The system should respond to user inputs and complete the corresponding action within "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("2")]),_v(" seconds.")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"cli-first-design"}},[_v("CLI-First Design"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#cli-first-design","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Primary Input Method: The system should prioritize "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CLI")]),_v(" for all core functionalities.")]),_v(" "),_c('li',[_v("One-Shot Commands: The system should support one-shot commands for users to perform tasks quickly.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Code Quality: The codebase should adhere to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Java coding standards")]),_v(" and include comprehensive documentation.")]),_v(" "),_c('li',[_v("Modularity: The system should be modular, allowing for easy updates or additions of new features.")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"testability"}},[_v("Testability"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#testability","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Unit Testing: At least "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("80%")]),_v(" code coverage should be achieved for all critical modules.")]),_v(" "),_c('li',[_v("Integration Testing: End-to-end testing should be conducted to ensure seamless interaction between modules.")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"quality-requirements"}},[_v("Quality Requirements"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#quality-requirements","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Usability: The system should be intuitive enough for new RAs and RFs to navigate without extensive training.")]),_v(" "),_c('li',[_v("Error Handling: Clear error messages should be displayed to guide users in resolving issues.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("RA")]),_v(": Resident Assistants")]),_v(" "),_c('li',[_c('strong',[_v("RF")]),_v(": Resident Fellows")]),_v(" "),_c('li',[_c('strong',[_v("Resident")]),_v(": Members residing in the residence")]),_v(" "),_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Adding a student")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: None")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add_stu name/John Doe matric/A0234567B phone/98765432 email/johnd@example.com a/311, Clementi Ave 2, #02-25 t/friend emergency/91234567 block/A level/5 room/3 designation/1")]),_c('br'),_v("\nExpected: Student will be added to the student list. Name, phone and email of the student will be shown in the status message. Timestamp in the status bar is updated.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add_stu name/Mary Jane matric/A0234568B phone/98765431 email/mary@example.com a/312, Clementi Ave 2, #02-25 t/friend emergency/91234567 block/A level/5 room/3 designation/1")]),_c('br'),_v("\nExpected: Student will be added to the student list. Name, phone and email of the student will be shown in the status message. Timestamp in the status bar is updated.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add_stu name/Harry Potter matric/A0234561B phone/98765412 email/harry@example.com a/313, Clementi Ave 2, #02-25 t/friend emergency/91234567 block/A level/5 room/3 designation/1")]),_c('br'),_v("\nExpected: Student will be added to the student list. Name, phone and email of the student will be shown in the status message. Timestamp in the status bar is updated.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add_stu name/John matric/A0234567B phone/99999999 email/john@example.com a/312, Clementi Ave 2, #02-25 t/friends emergency/91234568 block/B level/6 room/4 designation/2")]),_v("\nExpected: No student is added. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect add student commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add_stu")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add_stu name/John Doe matric/A0234567B phone/98765432 email/johnd@example.com")]),_c('br'),_v("\nExpected: Similar to previous.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Listing all students")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: None")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list_stu")]),_v("\nExpected: Student list will be shown. Message to inform user that students has been listed will be shown in the status message. Timestamp in the status bar is updated.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list_student")]),_v("\nExpected: Student list will not be shown. Message to inform user that input is an unknown command will be shown in the status message. Timestamp in the status bar is updated.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Deleting a student while all students are being shown")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all students using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple students in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete_stu 1")]),_c('br'),_v("\nExpected: First contact is deleted from the student list. Details of the deleted contact shown in the status message. Timestamp in the status bar is updated.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete_stu 0")]),_c('br'),_v("\nExpected: No student is deleted. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect delete commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete_stu")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete_stu x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is larger than the list size)"),_c('br'),_v("\nExpected: Similar to previous.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"searching-a-student"}},[_v("Searching a student"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#searching-a-student","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Adding a student")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: There must be students in the list")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("search_stu name/harry potter")]),_c('br'),_v("\nExpected: Students with names that match the search will show up in the list. Number of students that matched the search attributes and the search attributes will be shown in the status message. Timestamp in the status bar is updated.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("search_stu name/harry")]),_c('br'),_v("\nExpected: No students will show up in the list. Message to inform user that no matching students with the search attributes shown in the status message. Timestamp in the status bar is updated.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("search name/harry potter")]),_c('br'),_v("\nExpected: No students will show up in the list. Message to inform user that input is an unknown command will be shown in the status message. Timestamp in the status bar is updated.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect search student commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("search_stu name/har")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("search_stu matric/A0")]),_c('br'),_v("\nExpected: Similar to previous.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"edit-functionality"}},[_v("Edit Functionality"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#edit-functionality","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Add support for editing existing entries (students, staff, external parties or events). e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit_stu name/Alice email/Alice@example.com")]),_v(".")]),_v(" "),_c('li',[_v("Users will be able to update one or more fields of an existing person based on their index in their respective lists.")]),_v(" "),_c('li',[_v("Only the specified fields will be updated, fields not included will remain unchanged.")]),_v(" "),_c('li',[_v("Validation rules will still apply during editing. (e.g. for phone, email, matric)")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"partial-searching"}},[_v("Partial Searching"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#partial-searching","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Add support for partial and fuzzy searching. e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John")]),_v(" will match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John Doe")]),_v(", and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ball")]),_v(" will match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Basketball Training")]),_v(".")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"maximum-number-of-residents-in-a-room"}},[_v("Maximum Number of residents in a room"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#maximum-number-of-residents-in-a-room","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Add support for enforcing a limit on the number of different staff and students that can belong to the same combination of block, level and room.")])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Tue, 8 Apr 2025, 11:37:42 GMT+8]")])])])}
}];
