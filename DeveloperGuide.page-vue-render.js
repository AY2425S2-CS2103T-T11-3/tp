...
with(this){return _c('ul',[_c('li',[_v("has a need to manage a significant number of contacts of the residents(students), staff, and external vendors in a university hall")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": ResiConnect helps RA/RF to manage contacts of the students of a hall or contacts of the students, staff and external vendors of hall events.\nHaving an address book to note down all the important information about the people they are in charge of. It would be helpful for coordinating hall events, emergency situation, etc.")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Fri, 7 Mar 2025, 22:10:47 GMT+8]")])])])}
}];
