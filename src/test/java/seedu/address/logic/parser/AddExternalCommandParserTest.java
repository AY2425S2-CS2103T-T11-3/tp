...
public class AddExternalCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid phone
        assertParseFailure(parser, "name/ Bob Choo phone/ 911a email/ bob@example.com desc/ External supplier for food.",
        ...
        // invalid description (leading whitespace)
        //assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + " desc/  Starts with space",
        //        Description.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_NAME_DESC + INVALID_PHONE_DESC + EMAIL_DESC_BOB + DESCRIPTION_DESC_BOB,
                Name.MESSAGE_CONSTRAINTS);
    }
}
