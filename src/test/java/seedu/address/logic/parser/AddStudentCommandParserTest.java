...
public class AddStudentCommandParserTest {
    ...
    @Test
    public void parse_allFieldsPresentExceptStudentDesignation_success() {
        Student expectedStudent = new StudentBuilder().build();

        assertParseSuccess(parser,
                " name/Amy Bee matric/A0345678 phone/85355255 email/amy@gmail.com a/123, "
                        + "Jurong West Ave 6, #08-111 emergency/91234567 block/A level/7 room/5",
                new AddStudentCommand(expectedStudent));
    }

    @Test
    public void parse_allFieldsPresentWithStudentDesignation_success() {
        Student expectedStudent = new StudentBuilder().build();
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                + " matric/A0345678 emergency/91234567 block/A level/7 room/5 "
        ...
        // invalid matric
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + " emergency/91234567 block/A level/10 room/ABC designation/0", Matric.MESSAGE_CONSTRAINTS);
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser,
                " matric/A0345678 phone/85355255 email/amy@gmail.com a/123, "
                        + "Jurong West Ave 6, #08-111 emergency/91234567 block/A level/7 room/5",
                expectedMessage);
        ...
        assertParseFailure(parser,
                " name/Amy Bee matric/A0345678 email/amy@gmail.com a/123, "
                        + "Jurong West Ave 6, #08-111 emergency/91234567 block/A level/7 room/5",
                expectedMessage);

        // missing email prefix
        assertParseFailure(parser,
                " name/Amy Bee matric/A0345678 phone/85355255 a/123, "
                        + "Jurong West Ave 6, #08-111 emergency/91234567 block/A level/7 room/5",
                expectedMessage);

        // missing address prefix
        assertParseFailure(parser,
                " name/Amy Bee matric/A0345678 phone/85355255 email/amy@gmail.com "
