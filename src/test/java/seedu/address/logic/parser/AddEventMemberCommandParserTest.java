...
public class AddEventMemberCommandParserTest {

    private final AddEventMemberCommandParser parser = new AddEventMemberCommandParser();
    ...
    @Test
    public void parse_invalidMultipleMembers_failure() {
    ...
    public void parse_invalidEventIndex_throwsParseException() {
        ...
        assertEquals(MESSAGE_INVALID_EVENT_DISPLAYED_INDEX + "\n"
                + AddEventMemberCommand.MESSAGE_USAGE, thrown.getMessage());
    }
